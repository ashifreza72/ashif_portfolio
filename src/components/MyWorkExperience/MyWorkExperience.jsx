...
const MyWorkExperience = () => {
  return (
    <section className='workExpWrap py-[4.5rem] md:py-[5.5rem] lg:py-[6.5rem] xl:py-[7.5rem relative w-full'>
      <span className='bg-accent absolute right-0 bottom-[-.75rem] h-8 w-1/2'></span>
      <div
      ...
      <div className='container sm:container md:container lg:container xl:max-w-[86.875rem] mx-auto'>
        <SectionTitleLight
          ...
          desc='Experienced frontend developer with a strong focus on React.js. Proficient in crafting 
dynamic and responsive user interfaces using React components and state 
management libraries. Skilled in optimizing React applications for performance and 
scalability. Passionate about creating seamless user experiences through clean and 
