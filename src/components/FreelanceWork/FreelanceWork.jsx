...
import FreelanceWorkMockup from '../../assets/images/resources/ashif.png';

const FreelanceWork = () => {
  return (
    <section className=' mt-10 mb-10 freelanceWorkWrap w-full relative z-[1]'>
            ...
            <div>
              <div className='freelanceInfo w-full'>
                ...
                <p className='text-desc sm:text-[1.125rem] md:text-[1.125rem] lg:text-[1.25rem] mt-3'>
                  I am Md. Ashif, a versatile software developer with over 2
                  years of experience in the industry, including significant
                  freelance work. I have successfully delivered a range of
                  projects for clients as a freelancer. I am passionate about
                  leveraging my technical skills to create innovative and
