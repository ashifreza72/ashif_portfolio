import PostImg1 from '../assets/images/resources/postDetailImg1-1.jpg';
import PostImg2 from '../assets/images/resources/postDetailImg1-2.jpg';
import PostImg3 from '../assets/images/resources/postDetailImg1-3.jpg';
import PostImg4 from '../assets/images/resources/postDetailImg1-4.jpg';
import PostImg5 from '../assets/images/resources/postDetailImg1-5.jpg';
import PostImg6 from '../assets/images/resources/postDetailImg1-6.jpg';

export const postDetail = [
  {
    postImg: PostImg1,
    postTitle: 'Graphic Illustration',
    postComments: '35',
    postLikes: '40',
    postCateList: [
      {
    ...
    postTitle2: 'What makes the best co-working space?',
    postInfoList: [
      {
        infoItem: 'Website:',
